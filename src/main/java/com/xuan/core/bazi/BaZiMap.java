...
public class BaZiMap {
    ...
    public static final Map<String, List<String>> MING_GUA_FEN_XI = new HashMap<String, List<String>>() {
...

        {
            ...
            put("震卦（东四命）", Arrays.asList("三碧震木禄存星，北斗第三星，大吉星。十二宫中皆为福论，并有解厄制化之功。禄存星不入辰、戌、丑、未四墓宫，免除天罗地网的限制，主人一生运势甚平顺，波折较小。禄存星又名天禄星，为原财星，化气为富贵，主天禄。顾名思义，禄存星是既能得到“禄”，又可获得积“存”，关系着人一生的荣华富贵，是最标准的财星。主自信心，工作能稳扎稳打，不疾不徐，专注安定，保守拘谨，可独善己身，独立性强，凡事多靠自己打拼，不依赖别人，不强求埋怨，能获得重任。具有节制、储蓄、稳固性质，积德之财。有德者财源不绝，无德者劳碌挣财。禄存为羊陀所夹，亦代表要赚取钱财，必同时带有是非与劳累；内心常感孤寂，常为保守吝啬守财奴，不懂享受财富乐趣，从事管理钱财或货物可趋吉避凶。禄存星前后二邻宫有擎羊、陀罗双煞星相夹纹，以保护天禄，使得禄存星必须瞻前顾后，前冲后扯，行事因而保守稳重，宽厚节约，往往在富有之后，容易遭人嫉妒排挤，并产生纠纷，对此须多加注意。", "震卦在后天八卦中代表东方，五行属木。适宜住在坐北向南的住宅，有助于吸收自然界的正能量，提升居住者的运势。大门通常朝向西方，这是因为震宫为正福德宫，一切门、房、井、灶等设施方位都要从震宫数起，而大门作为住宅的纳气口，其朝向对住宅的整体风水有着重要影响。道路宜由东方伸展，这符合震卦的东方属性，有助于震命人在家中行走时感受到积极向上的气场。灶台宜在住宅的南方，样的布局有助于提升家中的财运和健康运。在八宅风水中，震宅的四吉位包括东南方（延年方）、南方、北方、东方（生气方），这些方位适合放置床位、书桌、沙发等家具，有助于提升居住者的运势和健康；震宅的四凶位包括西南方、西方、西北方、东北方，这些方位应避免放置重要家具或作为经常活动的区域，以免对居住者造成不利影响。在进行风水调整时，应遵循自然规律和人文传统，避免盲目追求风水效果而忽略居住者的实际需求和生活习惯。")); // 三碧震木禄存星
     ...
     * 男命骨重批注（骨重为键）
     */
    public static final Map<Integer, String> MAN_GU_ZHONG_YUAN_WEN = new HashMap<Integer, String>() {
        private static final long serialVersionUID = -1;
     ...
     * 女命骨重批注（骨重为键）
     */
    public static final Map<Integer, String> WOMAN_GU_ZHONG_YUAN_WEN = new HashMap<Integer, String>() {
        private static final long serialVersionUID = -1;
