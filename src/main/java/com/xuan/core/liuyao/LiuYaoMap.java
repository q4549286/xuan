...
public class LiuYaoMap {
     ...
     * 地支，用于计算卦身（索引为键）
     */
    public static final Map<Integer, List<String>> DI_ZHI_GUA_SHEN = new HashMap<Integer, List<String>>() {
        private static final long serialVersionUID = -1;

        {
            put(0, Arrays.asList("子", "丑", "寅", "卯", "辰", "巳"));
            put(1, Arrays.asList("午", "未", "申", "酉", "戌", "亥"));
        }
    };
    ...
    /**
     * 六十四卦的六爻干支纳音（六十四卦卦象为键）
     */
    public static final Map<String, List<String>> LIU_SHI_SI_GUA_LIU_YAO_GAN_ZHI_NA_YIN = new HashMap<String, List<String>>() {
        private static final long serialVersionUID = -1;
    ...
    public static final Map<String, String> YI_MA = new HashMap<String, String>() {
        ...
        /*
            【驿马】算法（此处采用传统查法）
                ...
                1、传统查法：时地支→ (申\子\辰)马为'寅'、(寅\午\戌)马为'申、(巳\酉\丑)马为'亥'、(亥\卯\未)马为'巳'。1天1个。
