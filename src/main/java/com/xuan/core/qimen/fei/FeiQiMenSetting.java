...
public class FeiQiMenSetting {
     ...
     * 人盘排法（0:转宫。1:飞宫）
     */
    private int renPanFeiZhuan;

    /**
     * 人盘转宫法（0:阴遁和阳遁一律顺转九宫。1:阴遁逆转九宫、阳遁顺转九宫）
     */
    private int renPanZhuanGong;

    /**
     * 人盘飞宫法（0:阴遁和阳遁一律顺飞九宫。1:阴遁逆飞九宫、阳遁顺飞九宫）
     */
    private int renPanFeiGong;

    /**
     * 天盘飞宫法（0:阴遁和阳遁一律顺飞九宫。1:阴遁逆飞九宫、阳遁顺飞九宫）
     */
    private int tianPanFeiGong;

    /**
     * 神盘飞宫法（0:阴遁和阳遁一律顺飞九宫。1:阴遁逆飞九宫、阳遁顺飞九宫）
     */
    private int shenPanFeiGong;
...
//************************************************************************************************************************************
     ...
     * @param date 公历日期
     */
    public FeiQiMenSetting(Date date) {
     ...
     */
    public FeiQiMenSetting(Date date, int dateType) {
     ...
     * @param hour  时
     */
    public FeiQiMenSetting(int year, int month, int day, int hour) {
     ...
     * @param dateType 日期类型（0:公历。1:农历）
     */
    public FeiQiMenSetting(int year, int month, int day, int hour, int dateType) {
    ...
    private void initialize() {
        ...
        this.jieQi = 1; // 节气算法（默认→ 按分钟计算）
        this.zhiShi = 0; // 值使排法（默认→ 天禽星为值符时，一律用[死门]为值使)
        this.renPanFeiZhuan = 1; // 人盘排法（默认→ 飞宫）
        this.renPanZhuanGong = 0; // 人盘转宫法（默认→ 阴遁和阳遁一律顺转九宫）
        this.renPanFeiGong = 0; // 人盘飞宫法（默认→ 阴遁和阳遁一律顺飞九宫）
        this.tianPanFeiGong = 0; // 天盘飞宫法（默认→ 阴遁和阳遁一律顺飞九宫）
        this.shenPanFeiGong = 1; // 神盘飞宫法（默认→ 阴遁逆飞九宫、阳遁顺飞九宫）
        this.paiPanMark = "时家奇门（飞盘拆补法）"; // $ 排盘标识
...
//------------------------------------------------------------------------------------------------------------------------------------
    ...
    public void setQiMenType(int qiMenType) {
        if (qiMenType != 0 && qiMenType != 1 && qiMenType != 2 && qiMenType != 3) {
            ...
            if (qiMenType == 0) this.paiPanMark = "年家奇门（飞盘拆补法）";
            if (qiMenType == 1) this.paiPanMark = "月家奇门（飞盘拆补法）";
            if (qiMenType == 2) this.paiPanMark = "日家奇门（飞盘拆补法）";
            if (qiMenType == 3) this.paiPanMark = "时家奇门（飞盘拆补法）";
     ...
     * 人盘排法设置
     *
     * @param renPanFeiZhuan 人盘排法（0:转宫。1:飞宫）
     */
    public void setRenPanFeiZhuan(int renPanFeiZhuan) {
        boolean boo = (renPanFeiZhuan == 0 || renPanFeiZhuan == 1);
        this.renPanFeiZhuan = boo ? renPanFeiZhuan : 0;
    }

    /**
     * 人盘转宫法设置
     *
     * @param renPanZhuanGong 人盘转宫法（0:阴遁和阳遁一律顺转九宫。1:阴遁逆转九宫、阳遁顺转九宫）
     */
    public void setRenPanZhuanGong(int renPanZhuanGong) {
        boolean boo = (renPanZhuanGong == 0 || renPanZhuanGong == 1);
        this.renPanZhuanGong = boo ? renPanZhuanGong : 1;
    }

    /**
     * 人盘飞宫法设置
     *
     * @param renPanFeiGong 人盘飞宫法（0:阴遁和阳遁一律顺飞九宫。1:阴遁逆飞九宫、阳遁顺飞九宫）
     */
    public void setRenPanFeiGong(int renPanFeiGong) {
        boolean boo = (renPanFeiGong == 0 || renPanFeiGong == 1);
        this.renPanFeiGong = boo ? renPanFeiGong : 0;
    }

    /**
     * 天盘飞宫法设置
     *
     * @param tianPanFeiGong 天盘飞宫法（0:阴遁和阳遁一律顺飞九宫。1:阴遁逆飞九宫、阳遁顺飞九宫）
     */
    public void setTianPanFeiGong(int tianPanFeiGong) {
        boolean boo = (tianPanFeiGong == 0 || tianPanFeiGong == 1);
        this.tianPanFeiGong = boo ? tianPanFeiGong : 0;
    }

    /**
     * 神盘飞宫法设置
     *
     * @param shenPanFeiGong 神盘飞宫法（0:阴遁和阳遁一律顺飞九宫。1:阴遁逆飞九宫、阳遁顺飞九宫）
     */
    public void setShenPanFeiGong(int shenPanFeiGong) {
        boolean boo = (shenPanFeiGong == 0 || shenPanFeiGong == 1);
        this.shenPanFeiGong = boo ? shenPanFeiGong : 1;
    }
