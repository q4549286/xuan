...
//        LiuYao liuYao = new LiuYao(date, 1); // 使用日期、日期类型初始化
...
//        LiuYao liuYao = new LiuYao(2024, 1, 1, 0, 0, 0, 1); // 使用年月日时分秒、日期类型初始化
        ...
        System.out.println("地区：" + liuYao.getAddress());
        ...
        System.out.println("本卦干支纳音：" + liuYao.getBenGuaLiuYaoGanZhiNaYin());
        ...
        System.out.println("变卦干支纳音：" + liuYao.getBianGuaLiuYaoGanZhiNaYin());
        ...
        System.out.println("互卦干支纳音：" + liuYao.getHuGuaLiuYaoGanZhiNaYin());
        ...
        System.out.println("错卦干支纳音：" + liuYao.getCuoGuaLiuYaoGanZhiNaYin());
        ...
        System.out.println("综卦干支纳音：" + liuYao.getZongGuaLiuYaoGanZhiNaYin());
        ...
        System.out.println("伏卦：" + liuYao.getFuGua());
        ...
        System.out.println("伏卦爻名：" + liuYao.getFuGuaLiuYaoName());
        System.out.println("伏卦爻象：" + liuYao.getFuGuaLiuYaoAs());
        System.out.println("伏卦世应：" + liuYao.getFuGuaLiuYaoShiYing());
        System.out.println("伏卦六亲：" + liuYao.getFuGuaLiuYaoLiuQin());
        System.out.println("伏卦干支：" + liuYao.getFuGuaLiuYaoGanZhi());
        System.out.println("伏卦五行：" + liuYao.getFuGuaLiuYaoWuXing());
        System.out.println("伏卦干支纳音：" + liuYao.getFuGuaLiuYaoGanZhiNaYin());
        System.out.println("伏卦六神：" + liuYao.getFuGuaLiuYaoLiuShen());
        System.out.println("伏卦爻辞：" + liuYao.getFuGuaLiuYaoYaoCi());
        System.out.println("伏卦伏神：" + liuYao.getFuGuaLiuYaoFuShen());
