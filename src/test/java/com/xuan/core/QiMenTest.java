...
//        date = TrueSolarDateUtil.getTrueSolarDate(date, address); // 获取真太阳时（TODO：请填写真实地区）
        ...
        setting.setJieQi(1); // 节气算法（0:按天计算。1:按分钟计算）
...
//        ZhuanQiMen qiMen = new ZhuanQiMen(date, 1); // 使用日期、日期类型初始化
...
//        ZhuanQiMen qiMen = new ZhuanQiMen(2024, 1, 1, 0, 0, 0, 1); // 使用年月日时分秒、日期类型初始化
        ...
        System.out.println("地区：" + qiMen.getAddress());
...
//        FeiQiMen qiMen = new FeiQiMen(date, 1); // 使用日期、日期类型初始化
